...
LoginScreen::LoginScreen()
{
	...
	label->SetTextColor(ClientAPI::Color.Light_Grey);
	labels.push_back(label);
	textInputs.push_front(new TextInput(ClientAPI::createRectangle(400, 250, 474, 100), ClientAPI::Font.Ostrich_Regular_72));
	...
	labels.push_back(label);
	label->SetTextColor(ClientAPI::Color.Light_Grey);
	textInputs.push_front(new TextInput(ClientAPI::createRectangle(400, 400, 474, 100), ClientAPI::Font.Ostrich_Regular_72));
